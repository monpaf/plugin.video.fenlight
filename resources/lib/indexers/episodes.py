	...
	def _process():
		for item in episodes_data:
			try:
				...
				info_tag.setDuration(duration), info_tag.setIMDBNumber(imdb_id), info_tag.setUniqueIDs({'imdb': imdb_id, 'tvshow.tmdb': str(tmdb_id), 'tmdb': str(tmdb_id), 'tvdb': str(tvdb_id)})
